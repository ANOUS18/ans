...
OWNER_NAME = getenv("OWNER_NAME", "T - he villain .")
OWNER_NyyyAME = getenv("OWNER_NyyyAME", "5209139258")
BOT_USERNAME = getenv("BOT_USERNAME", "source_mu_bot")
ASSISTANT_NAME = getenv("ASSISTANT_USERNAME", "Qivcz")
BOT_TOKEN = getenv("BOT_TOKEN", "7119081040:AAEnuS_T_-eLG6wLcQb40aHRe93GktNpG_c")
